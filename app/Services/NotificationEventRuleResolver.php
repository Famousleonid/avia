...
class NotificationEventRuleResolver
{
    ...
    protected function variables(array $message): array
    {
        return [
            ...
            'detail_label' => (string) (Arr::get($message, 'ui.part.label') ?? Arr::get($message, 'payload.detail_label') ?? ''),
            'part_name' => (string) (Arr::get($message, 'ui.part.name') ?? Arr::get($message, 'payload.part_name') ?? ''),
            'part_number' => (string) (Arr::get($message, 'ui.part.number') ?? Arr::get($message, 'payload.part_number') ?? ''),
            'serial_number' => (string) (Arr::get($message, 'ui.unit.serial_number') ?? Arr::get($message, 'payload.serial_number') ?? ''),
