...
use App\Http\Controllers\Admin\MarketingWoFileController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/password/required', [RequiredPasswordChangeController::class, 'update'])
...
Route::group(['middleware' => ['auth', 'verified', 'desktop']], function () {
    ...
    Route::middleware('can:feature.marketing')->group(function () {
        ...
        Route::get('/marketing/workorders/{workorder}/files', [MarketingWoFileController::class, 'index'])->name('marketing.workorders.files.index');
        Route::post('/marketing/workorders/{workorder}/files', [MarketingWoFileController::class, 'store'])->name('marketing.workorders.files.store');
        Route::get('/marketing/workorders/{workorder}/files/{marketingWoFile}/preview', [MarketingWoFileController::class, 'preview'])->name('marketing.workorders.files.preview');
        Route::get('/marketing/workorders/{workorder}/files/{marketingWoFile}/download', [MarketingWoFileController::class, 'download'])->name('marketing.workorders.files.download');
  ...
  //  Route::patch('/mains/general-task/{workorder}/{generalTask}', [MainController::class, 'updateGeneralTaskDates'])->name('mains.updateGeneralTaskDates');
    ...
    Route::post('/workorders/{workorder}/update-part-processes/preview', [WoMeasurementController::class, 'previewPartProcesses'])->name('workorders.update-part-processes.preview');
    ...
    Route::patch('/materials/{material}/inline', [MaterialController::class, 'inlineUpdate'])->name('materials.inline');
        ...
        Route::post('trainings/matrix-rows', [TrainingController::class, 'matrixRowStore'])->name('trainings.matrixRows.store');
        ...
        Route::post('trainings/matrix-legacy', [TrainingController::class, 'matrixLegacyStore'])->name('trainings.matrixLegacy.store');
        Route::post('trainings/matrix-legacy-remove', [TrainingController::class, 'matrixLegacyRemove'])->name('trainings.matrixLegacy.remove');
