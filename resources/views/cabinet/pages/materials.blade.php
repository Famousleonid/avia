...
@section('content')
    ...
    <section class="container pl-3 pr-3 mt-2">
        <div class="card firm-border p-2 shadow">
            <div class="card-body p-0 pt-2">
                <div class="box-body ">
                    ...
                    @if(count($materials))
                        <table data-page-length='25' id="show-materials" class="display table-sm table-bordered table-striped table-hover theme-sensitive" style="width:100%;">
                            <thead>
                            <tr>
