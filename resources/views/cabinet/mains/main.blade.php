        ...
        <div class="card-body p-0">
            <div class="row g-3 flex-column flex-md-row align-items-md-start">
                ...
                <div class="col-12 col-md">
                    <form id="general_task_form" action="{{route('cabinet.mains.create')}}" class="row g-3 align-items-end mx-md-3">
                        @csrf
                        ...
                        <table id="main-index" class="display table-sm table-bordered table-striped table-hover w-100">
                            ...
                            @foreach ($mains as $index => $main)
                                <tr>
                                    ...
                                    @endif
                                    <td class="text-center">
                                        <form action="{{route('cabinet.mains.destroy', ['main' => $main->id])}}" method="post">
                                            @csrf
                                            @method('DELETE')
