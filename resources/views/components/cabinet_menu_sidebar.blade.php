...
<ul class="nav flex-column" data-accordion="false">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{route('cabinet.trainings.index')}}" onclick="showLoadingSpinner()">
            <i class="bi bi-list-check me-2"></i> Training
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{route('cabinet.manuals.index')}}"
    ...
    @endif
    <li class="nav-item">
        <a class="nav-link" href="{{route('cabinet.users.index')}}" onclick="showLoadingSpinner()">
            <i class="bi bi-airplane me-2"></i> Techniks
        </a>
    </li>
    <li class="nav-item">
        <a href="{{route('cabinet.materials.index')}}" class="nav-link" onclick="showLoadingSpinner()">
