        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="createForm" method="POST" action="{{ route('admin.customers.store') }}">
                        @csrf
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" method="POST" action="{{ route('admin.customers.update', ':id') }}">
                        @csrf
                        @method('PUT')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="deleteForm" method="POST" action="{{ route('admin.customers.destroy', ':id') }}">
                        @csrf
                        @method('DELETE')
...
@section('scripts')
    <script>
        ...
        function populateEditModal(id, name) {
            ...
            document.getElementById('editForm').action = `{{ route('admin.customers.update', ':id') }}`.replace(':id', id);
        }

        function populateDeleteModal(id, name) {
            document.getElementById('deleteId').value = id;
            document.getElementById('deleteForm').action = `{{ route('admin.customers.destroy', ':id') }}`.replace(':id', id);
