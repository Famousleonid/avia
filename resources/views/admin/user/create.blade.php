        ...
        <div class="card bg-gradient">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.users.store') }}"
                    ...
                    <button type="submit" class="btn btn-outline-primary mt-3">{{ __
                    ('Create') }}</button>
                    <a href="{{ route('admin.users.index') }}" class="btn
                        btn-outline-secondary mt-3">{{ __('Cancel') }} </a>
                ...
                <form method="POST" id="addRoleForm">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-between ">
                            ...
                            <div class="form-group">
                                <label for="roleName">{{ __('New Role')
                                }}</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-outline-primary">{{ __('Save
                        Role') }}</button>
                    </div>
