                    ...
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ $user->getBigImageUrl('avatars') }}" data-fancybox="gallery">
                                    <img class="rounded-circle" src="{{ $user->getThumbnailUrl('avatars') }}" width="50" height="50" alt="Image"/>
                                </a>
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-center">
                                <a href="{{route('admin.users.edit', ['user' => $user->id]) }}"><img src="{{asset('img/set.png')}}" width="25" alt=""></a>
                            </td>
                        </tr>
