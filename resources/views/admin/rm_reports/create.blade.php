...
{{--                                                   value="{{ old('note' . $i, $current_wo->rm_report ? json_decode($current_wo->rm_report, true)['technical_notes']['note' . $i] ?? '' : '') }}"--}}
            ...
            <div id="rmRecordsList">
                ...
                <!-- Отображение текущих сохраненных записей -->
                                ...
                                <div class="mb-2">
                                    ...
                                    <ul class="mb-0">
                                        @foreach($savedData['rm_records'] as $record)
                                            <li>{{ $record['part_description'] }} - {{ $record['mod_repair'] }}</li>
                                        @endforeach
                                    </ul>
                                </div>
                            @endif
                ...
                <div class="row mt-3 mb-2">
                        ...
                        <div class="col-md-6 text-end">
                            <button type="button" class="btn btn-outline-success btn-sm" onclick="saveSelectedRecords()">
                                <i class="fas fa-save"></i> {{ __('Save Selected to Work Order') }}
                            </button>
                        </div>
                    </div>
