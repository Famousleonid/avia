    ...
    <div class="card shadow">
        <div class="card-header my-1 shadow">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex my-2 gap-2 flex-wrap">
                    <!-- Filter by Manual -->
                    <div>
                        <select id="manualFilter" class="form-select" style="height: 40px; min-width: 200px;">
        ...
        @if(count($components))
            <div class="table-wrapper me-3 p-2 pt-0">
                <table id="componentsTable" class="display table table-sm table-hover bg-gradient table-striped align-middle table-bordered">
