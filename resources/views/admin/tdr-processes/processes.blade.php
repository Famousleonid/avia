            ...
            <div class="card-body">
                <div class="me-3">
                    <div class="table-wrapper me-3">
                        <table class="display table table-sm table-hover align-middle bg-gradient sortable-table dir-table tdr-processes-table">
                            <thead>
                            <tr>
                                ...
                                @if($processes->tdrs_id == $current_tdr->id)
                                    ...
                                    @if($isEc)
                                        ...
                                        <tr data-id="{{ $processes->id }}">
                                            ...
                                            <td class="text-center">
                                                @if($isEcEditable)
                                                    {{-- Активные кнопки, когда EC единственный процесс --}}
                                                ...
                                                @else
                                                    {{-- НЕАКТИВНЫЕ кнопки для EC (когда есть Machining(EC) или RIL) --}}
                                                    <a href="#"
