    ...
    <div class="row">
        <div class="col">
            ...
            <div class="mt-1 d-flex">
                <button type="button" class="btn btn-link p-0 me-3" data-bs-toggle="modal" data-bs-target="#addComponentModal">
                    {{ __('Add Part') }}
                </button>
                <button type="button" class="btn btn-link p-0" id="editComponentBtn">{{ __('Edit Part') }}</button>
            </div>
        </div>
        <div class="col">
