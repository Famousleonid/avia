        ...
        <div class="row">
            ...
            <div class="col-5">
                ...
                <div class="row" style="height: 32px">
                    ...
                    <div class="col-8 pt-2 border-b">Micro Custom</div>
                </div>
                <div class="row" style="height: 32px">
...
{{--                    </div>--}}
    ...
    <div class="page table-header">
        <div class="row mt-2">
            ...
            <div class="col-2 border-l-t-b pt-2 details-row text-center"><h6 class="fs-7"><strong>PART No.</strong></h6></div>
            <div class="col-2 border-l-t-b pt-2 details-row text-center"><h6 class="fs-7"><strong>DESCRIPTION</strong></h6></div>
            <div class="col-4 border-l-t-b pt-2 details-row text-center"><h6 class="fs-7"><strong>PROCESS No.</strong></h6></div>
            <div class="col-1 border-l-t-b pt-2 details-row text-center"><h6 class="fs-7"><strong>QTY</strong></h6></div>
            <div class="col-2 border-all pt-2 details-row text-center"><h6 class="fs-7"><strong>CMM No.</strong></h6></div>
        </div>
    </div>
