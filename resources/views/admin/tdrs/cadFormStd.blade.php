                ...
                <form id="printSettingsForm">
                    ...
                    <div class="mb-4">
                        <h5 class="mb-3" data-bs-toggle="tooltip" 
                            ...
                            title="Настройки количества строк в таблице CAD. Строки сверх лимита скрываются при печати. Настройки применяются автоматически при загрузке страницы."
                            data-tooltip-ru="Настройки количества строк в таблице CAD. Строки сверх лимита скрываются при печати. Настройки применяются автоматически при загрузке страницы."
                            data-tooltip-en="CAD table row settings. Rows exceeding the limit are hidden when printing. Settings are applied automatically on page load.">
                            📊 Tables
                        </h5>
                        
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="cadTableRows" class="form-label" data-bs-toggle="tooltip" 
                                        data-bs-placement="top" 
                                        title="Максимальное количество строк в таблице CAD на одной странице. По умолчанию: 19 строк. Используется для всех страниц формы."
                                        data-tooltip-ru="Максимальное количество строк в таблице CAD на одной странице. По умолчанию: 19 строк. Используется для всех страниц формы."
                                        data-tooltip-en="Maximum number of rows in CAD table per page. Default: 19 rows. Used for all pages of the form.">
                                    CAD Table (row)
                                </label>
                                <div class="input-group">
                                    <input type="number" class="form-control" id="cadTableRows" name="cadTableRows"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <label for="containerMaxWidth" class="form-label" data-bs-toggle="tooltip" 
                                                        data-bs-placement="top" 
                                                        title="Максимальная ширина контейнера с таблицей в пикселях. Рекомендуемое значение: 920px для CAD формы. Увеличьте, если таблица слишком узкая."
                                                        data-tooltip-ru="Максимальная ширина контейнера с таблицей в пикселях. Рекомендуемое значение: 920px для CAD формы. Увеличьте, если таблица слишком узкая."
                                                        data-tooltip-en="Maximum width of the table container in pixels. Recommended value: 920px for CAD form. Increase if the table is too narrow.">
                                                    Max Width (px)
                                                </label>
                                                <div class="input-group">
...
<script>
    ...
    const PRINT_SETTINGS_KEY = 'cadFormStd_print_settings';
    const TOOLTIP_LANG_KEY = 'cadFormStd_tooltip_lang';
    ...
    window.savePrintSettings = function() {
        try {
            ...
            const settings = {
                ...
                cadTableRows: getValue('cadTableRows', '19', '')
            };
    ...
    function loadSettingsToForm(settings) {
        const elements = {
            ...
            'cadTableRows': { suffix: '', default: '19' }
        };
