...
@section('style')
    ...
    <style>
        ...
        #paint-wo-table col.paint-col-num { width: 8%; }
        #paint-wo-table col.paint-col-wo { width: 14%; }
        #paint-wo-table col.paint-col-customer { width: 20%; }
        #paint-wo-table col.paint-col-aircraft { width: 15%; }
        #paint-wo-table col.paint-col-pn { width: 18%; }
        #paint-wo-table col.paint-col-owner { width: 10%; }
        #paint-wo-table col.paint-col-detail { width: 10%; }
        #paint-wo-table col.paint-col-date { width: 145px; }
        #paint-wo-table:not(.paint-table-has-drag) col.paint-col-num { width: 145px; }
        .paint-col-priority {
            max-width: 100%;
        }
                        ...
                        <table class="table table-sm table-hover align-middle mb-0 dir-table paint-dir-table {{ ($canReorderPaint ?? false) ? 'paint-table-has-drag' : '' }} " id="paint-wo-table">
                            ...
                            @forelse ($rows as $row)
                                ...
                                <tr data-wo-id="{{ (int) $wo->id }}"
                                    ...
                                    <td class="text-center paint-col-wrap">{{ $wo->unit?->part_number ?? '' }}</td>
