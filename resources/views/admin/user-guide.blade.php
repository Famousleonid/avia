...
<head>
    ...
    <style>
        ...
        .guide-live-main { align-self:stretch; display:flex; flex:1 1 auto; width:100%; min-height:0; overflow:hidden; border:1px solid #1597b7; border-radius:6px; background:#172532; }
        .guide-live-main iframe { flex:1 1 auto; width:100%; min-height:0; border:0; background:#172532; }
    ...
    <div class="guide-layout">
        <aside class="guide-toc" id="guideContents" aria-label="Guide contents">
            ...
            <nav class="guide-toc-accordion">
                ...
                <details><summary><span data-guide="tocFour">4. Workorder photos</span><i class="bi bi-chevron-down"></i></summary><div class="guide-toc-links"><a href="#photos" data-guide="tocFourOne">4.1 Add and group photos</a></div></details>
            </nav>
        </aside>
        <main class="guide-main">
            ...
            <section class="guide-section" id="training"><span class="guide-section-number">2.2</span><h2 class="guide-section-title" data-guide="trainingTitle">Training</h2><p class="guide-section-intro" data-guide="trainingText">Check assigned training.</p><figure class="guide-shot"><img src="{{ asset('img/user-guide/technician-training.png') }}" alt="AVIA Training page for Technician"><figcaption data-guide="trainingCaption">The second item in the Technician menu: Training.</figcaption></figure></section>
            <section class="guide-section" id="technicians"><span class="guide-section-number">2.3</span><h2 class="guide-section-title" data-guide="techniciansTitle">Technician</h2><p class="guide-section-intro" data-guide="techniciansText">Find the responsible technician.</p><figure class="guide-shot"><img src="{{ asset('img/user-guide/technician-technicians.png') }}" alt="AVIA Technician page for Technician role"><figcaption data-guide="techniciansCaption">The third item in the Technician menu: Technician.</figcaption></figure></section>
            <section class="guide-section" id="materials"><span class="guide-section-number">2.4</span><h2 class="guide-section-title" data-guide="materialsTitle">Materials</h2><p class="guide-section-intro" data-guide="materialsText">Find the approved material.</p><figure class="guide-shot"><img src="{{ asset('img/user-guide/technician-materials.png') }}" alt="AVIA Materials page for Technician"><figcaption data-guide="materialsCaption">The fourth item in the Technician menu: Materials.</figcaption></figure></section>
            <section class="guide-section" id="mobile-workorders"><span class="guide-section-number">3.1</span><h2 class="guide-section-title" data-guide="mobileTitle">Mobile application</h2><p class="guide-section-intro" data-guide="mobileText">Technician screens on a phone.</p><figure class="guide-shot guide-mobile-app-shot"><img src="{{ asset('img/user-guide/technician-mobile-workorders.png') }}" alt="AVIA mobile Workorders page for Technician"><figcaption data-guide="mobileShotList">Mobile: find the required workorder in the list.</figcaption></figure></section>
            <section class="guide-section" id="mobile-workorder"><span class="guide-section-number">3.2</span><h2 class="guide-section-title" data-guide="mobileWorkorderTitle">Open a workorder</h2><p class="guide-section-intro" data-guide="mobileWorkorderText">Open the work order details.</p><figure class="guide-shot guide-mobile-app-shot"><img src="{{ asset('img/user-guide/technician-mobile-workorder.png') }}" alt="AVIA mobile Workorder page for Technician"><figcaption data-guide="mobileShotWorkorder">Mobile: the opened workorder and its working sections.</figcaption></figure></section>
            <section class="guide-section" id="mobile-photos"><span class="guide-section-number">3.3</span><h2 class="guide-section-title" data-guide="mobilePhotosTitle">Photos on mobile</h2><p class="guide-section-intro" data-guide="mobilePhotosText">Add photos to the required group.</p><figure class="guide-shot guide-mobile-app-shot"><img src="{{ asset('img/user-guide/technician-mobile-photos.png') }}" alt="AVIA mobile Photos page for Technician"><figcaption data-guide="mobileShotPhotos">Mobile: photo groups, Add buttons and drop areas.</figcaption></figure></section>
            <section class="guide-section" id="photos"><span class="guide-section-number">4.1</span><h2 class="guide-section-title" data-guide="photosTitle">Add and group workorder photos</h2><p class="guide-section-intro" data-guide="photosText">Add and group workorder evidence.</p><ol class="guide-photo-steps"><li data-guide="photoOne">Open the correct work order and choose the Photos area.</li><li data-guide="photoTwo">Add clear JPG, PNG or WEBP files; wait until every selected file appears.</li><li data-guide="photoThree">Drag each uploaded photo into the appropriate group only after the target group is highlighted.</li><li data-guide="photoFour">Confirm that each group contains the required evidence before leaving the work order.</li></ol></section>
        </main>
    </div>
</div>
<script>
    (() => {
        ...
        if (mainDemo && mainDemo.isConnected) {
            ...
            window.UserUiSettings.get(scope, 'main-demo-draft', {}).then((draft) => {
            ...
            window.UserUiSettings.get(scope, 'main-demo-tab', 'all').then((savedTab) => setMainDemoTab(savedTab, false));
            window.UserUiSettings.get(scope, 'main-demo-status', 'Disassembly').then((savedStatus) => {
        ...
        nextButton.addEventListener('click', () => moveToSection(1));
        ...
        window.UserUiSettings.get(scope, 'language', 'en').then((saved) => setLanguage(saved, false));
        window.UserUiSettings.get(scope, 'workorder-interactive-state', workorderInteractiveState).then((saved) => {
        ...
        Promise.all([
            ...
            window.requestAnimationFrame(() => window.requestAnimationFrame(() => {
                ...
                else if (restoredSectionHash !== '#login-screen') scrollToGuideSection(document.querySelector(restoredSectionHash));
                window.requestAnimationFrame(() => { restoringGuidePosition = false; });
            }));
        });
    })();
</script>
