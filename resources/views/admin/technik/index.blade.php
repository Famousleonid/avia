...
@section('add-menu')
    ...
    <div class="ml-5">
        <a href="{{route('techniks.create')}}"><img src="{{asset('img/adduser.png')}}" width="30" alt=""></a>
                        ...
                        <table id="user-list" class="table-sm table-bordered table-striped table-hover " style="width:100%;">
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('techniks.edit', ['technik' => $user->id]) }}"><img src="{{asset('img/set.png')}}" width="25" alt=""></a>
                                    </td>
                                    <td class="text-center">
                                        <div>
                                            <form action="{{route('techniks.destroy', ['technik' => $user->id])}}" method="post">
                                                @csrf
                                                @method('DELETE')
