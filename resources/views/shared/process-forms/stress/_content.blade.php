{{--
    Контент Stress Relief формы.
    Переменные: process_tdr_components, process_components, manuals, current_wo, process_name
    formConfig: stress_table_rows (default 21)
--}}
@php
    $totalRows = $formConfig['stress_table_rows'] ?? 21;
    $dataRows = 0;
    if (isset($table_data)) {
...
<div class="row">
    <div class="col-6"></div>
    <div class="col-3 text-end pe-2 pt-3"><strong>MANUAL REF:</strong></div>
...
<h6 class="mt-4 ms-3"><strong>
    Perform the {{ ucwords(strtolower($process_name->process_sheet_name ?? $process_name->name ?? 'Stress Relief')) }}
...
<div class="page table-header">
    <div class="row mt-3">
        ...
        <div class="col-2 border-all pt-2 details-row text-center"><h6 class="fs-75"><strong>PERFORMED</strong></h6></div>
    </div>
</div>
<div class="page data-page">
    ...
    @for ($i = 0; $i < $emptyRows; $i++)
        <div class="row empty-row data-row" data-row-index="{{ $rowIndex }}" data-stress="true">
