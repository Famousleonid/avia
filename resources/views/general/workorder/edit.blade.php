...
@section('content')
    ...
    <div class="container pl-3 pr-3 mt-2">
        <div class="card firm-border p-2 bg-white shadow">
            ...
            <form id="createForm" class="createForm" role="form" method="POST" action="{{route('workorder.update', ['workorder' => $current_wo->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card-body row" id="create_div_inputs">
                                ...
                                <div class="form-group col-lg-3 mt-2">
                                    ...
                                    <input type="text" name="serial_number" id="serial_number" value="{{$current_wo->serial_number}}" class="form-control @error('serial_number') is-invalid @enderror" placeholder="S/N">
                                </div>
                                <div class="form-group col-lg-3 mt-2">
                                ...
                                <div class="form-group col-lg-3 mt-2">
                                    <label for="number_id">Place</label>
                                    <input type="text" name="place" id="place" value="{{$current_wo->place}}" class="form-control @error('place') is-invalid @enderror" placeholder="A1-D2-C3">
                                </div>
                                <div class="form-group col-lg-3 mt-2">
                                    <label for="number_id">Date of creation</label>
                                    <input type="date" name="created_at" id="date_created_at" value="{{$current_wo->created_at->format('Y-m-d')}}" class="form-control @error('created_at') is-invalid @enderror">
                                </div>
                            ...
                            <div class="form-group container-fluid ">
                                <div class="card-body row ">
                                    <div class="col-lg-3 mb-1">
                                        <button id="ntSaveFormsSubmit" type="submit" class="btn btn-primary btn-block ntSaveFormsSubmit" onclick="showLoadingSpinner()">Save</button>
                                    </div>
