...
Паритет iOS/Android — в `docs/mobile-feature-matrix.md`. Каждый коммит с новой фичей клиента или изменением контракта обновляет соответствующую строку матрицы в том же коммите.
