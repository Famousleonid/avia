...
| Machining: фото/PDF | `…/photos`, `…/doc-pdfs`, `…/pdfs`, `DELETE …/media/{id}` | ❓ | ✅ | 23.07 (3f5f62d): сетка фото/карусель/съёмка/удаление, PDF-сканы + внешний просмотрщик, счётчики на WO-экране |
